<div class="box-body">
    ...
    <div class='form-group{{ $errors->has("{$lang}[description]") ? ' has-error' : '' }}'>
        ...
        <?php $old = $category->hasTranslation($locale) ? $category->translate($lang)->description : '' ?>
        {!! Form::textarea("{$lang}[description]", old("{$lang}[description]", $old), ['class' => 'form-control', 'placeholder' => trans('blog::category.form.description')]) !!}
