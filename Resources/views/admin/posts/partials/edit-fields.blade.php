<div class="box-body">
    <div class='form-group{{ $errors->has("$lang.title") ? ' has-error' : '' }}'>
        <?php $oldTitle = isset($post->translate($post->locale)->title) ? $post->translate($post->locale)->title : ''; ?>
    ...
    <div class='form-group{{ $errors->has("$lang.slug") ? ' has-error' : '' }}'>
        <?php $oldSlug = isset($post->translate($post->locale)->slug) ? $post->translate($post->locale)->slug : ''; ?>
    ...
    <?php $oldContent = isset($post->translate($post->locale)->content) ? $post->translate($post->locale)->content : ''; ?>
